      ...
      <div className={styles.content}>
        ...
        <div className={styles.categories}>
          <div className={styles.badge} style={badge3Style}>
            <div className={styles.badgeBase} style={badgeBase1Style}>
          ...
          <div className={styles.badge1}>
            <div className={styles.badgeBase1} style={badgeBase2Style}>
          ...
          <div className={styles.badge2} style={badge4Style}>
            <div className={styles.badgeBase2} style={badgeBase3Style}>
