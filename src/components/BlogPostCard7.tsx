...
import styles from "./BlogPostCard7.module.css";

export type BlogPostCard7Type = {
  className?: string;
  image?: string;
};

const BlogPostCard7: FunctionComponent<BlogPostCard7Type> = ({
  className = "",
  image,
}) => {
  return (
