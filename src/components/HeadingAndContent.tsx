...
import styles from "./HeadingAndContent.module.css";

export type HeadingAndContentType = {
  className?: string;
};

const HeadingAndContent: FunctionComponent<HeadingAndContentType> = ({
  className = "",
}) => {
  return (
    <div className={[styles.headingAndContent, className].join(" ")}>
